...
| [`skills/`](skills/) | **Procedimientos repetibles**, uno por tipo de trabajo (`new-task`, `delivery-e2e` —cuánto dura una TASK, sus modos y cuándo se para—, `bugfix`, `money-change`, `database-migration`, `security-change`, `ui-change`, `audit`, `production-release`). |
