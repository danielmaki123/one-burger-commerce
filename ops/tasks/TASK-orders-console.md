...
| **B5 · Umbrales por local** | `acceptAlertMinutes` y `prepAlertMinutes` por local, editables en `/admin/locations`, y el tiempo promedio de preparación del día | Migración aditiva + el actor del cambio de estado | Siguiente |
