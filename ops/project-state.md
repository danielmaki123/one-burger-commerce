...
| 19 | **Plan de ejecución `plna.md` (orden + design system + POS)** | En curso (2026-09-14) | El contrato de trabajo es `plna.md` (raíz, **sin versionar**) y su base es `AUDITORIA-ESTADO-2026-09-14.md` (**sin versionar**): un chat nuevo no los ve desde `START-HERE.md`. **FASE 1 cerrada** (TASK-101 a 105) y **FASE 2 en curso** (TASK-201 y 202 hechas; 203 a 206 pendientes). **FASE 3 (POS, TASK-301 a 308) sin arrancar** y sin detalle escrito. **Contradicción de gobernanza a resolver en TASK-203**: `plna.md` §4.6 pide autonomía total y no pedir validación, mientras `AGENTS.md` exige una tarea por vez, preguntar el alcance antes de codear y no desplegar sin confirmación. |
